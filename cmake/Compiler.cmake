...
IF(CMAKE_C_COMPILER_ID MATCHES MSVC)
	SET(SAURON_COMPILER_NAME "vc")
	SET(SAURON_COMPILER_MSVC TRUE)
	IF(MSVC_VERSION GREATER 1900)
		SET(SAURON_COMPILER_VERSION "141")
	ELSE()
		SET(SAURON_COMPILER_VERSION "140")
	ENDIF()
	...
	IF(MSVC_VERSION GREATER 1900)
		...
		IF(MSVC_VERSION GREATER 1910)
			IF(SAURON_PLATFORM_WINDOWS_STORE OR (SAURON_ARCH_NAME STREQUAL "arm64"))
				SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /Zc:twoPhase-")
			ENDIF()
		ENDIF()
	ENDIF()
	SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /DSAURON_SHIP /fp:fast /Ob2 /GL /Qpar")
	...
	IF(SAURON_ARCH_NAME MATCHES "x86")
	...
	IF(SAURON_ARCH_NAME MATCHES "arm")
		ADD_DEFINITIONS(-D_ARM_WINAPI_PARTITION_DESKTOP_SDK_AVAILABLE=1)

		IF(SAURON_PLATFORM_WINDOWS_DESKTOP)
	...
	IF(SAURON_PLATFORM_WINDOWS_STORE)
...
ELSE()
	IF(CMAKE_C_COMPILER_ID MATCHES Clang)
		SET(SAURON_COMPILER_NAME "clang")
		SET(SAURON_COMPILER_CLANG TRUE)
		IF(MSVC)
			SET(SAURON_COMPILER_CLANGC2 TRUE)
		ENDIF()
	ELSEIF(MINGW)
		SET(SAURON_COMPILER_NAME "mgw")
		SET(SAURON_COMPILER_GCC TRUE)
	ELSE()
		SET(SAURON_COMPILER_NAME "gcc")
		SET(SAURON_COMPILER_GCC TRUE)
	ENDIF()
	IF((NOT MSVC) AND SAURON_PLATFORM_WINDOWS)
		ADD_DEFINITIONS(-D_WIN32_WINNT=0x0601 -DWINVER=_WIN32_WINNT)
	ENDIF()

	IF(SAURON_COMPILER_CLANG)
		...
		SET(SAURON_COMPILER_VERSION ${CLANG_MAJOR}${CLANG_MINOR})
	ELSE()
		EXECUTE_PROCESS(COMMAND ${CMAKE_C_COMPILER} -dumpversion OUTPUT_VARIABLE GCC_VERSION)
		STRING(REGEX MATCHALL "[0-9]+" GCC_VERSION_COMPONENTS ${GCC_VERSION})
		LIST(GET GCC_VERSION_COMPONENTS 0 GCC_MAJOR)
		LIST(GET GCC_VERSION_COMPONENTS 1 GCC_MINOR)
		SET(SAURON_COMPILER_VERSION ${GCC_MAJOR}${GCC_MINOR})
	ENDIF()
	...
	IF(SAURON_ARCH_NAME STREQUAL "x86")
		...
		IF(NOT MSVC)
			...
			ENDIF()
		ENDIF()
	ELSEIF((SAURON_ARCH_NAME STREQUAL "x64") OR (SAURON_ARCH_NAME STREQUAL "x86_64"))
...
IF(SAURON_COMPILER_MSVC)
	SET(RTTI_FLAG "/GR")
	SET(NO_RTTI_FLAG "/GR-")
ELSE()
	SET(RTTI_FLAG "-frtti")
	IF(SAURON_COMPILER_CLANGC2)
		SET(NO_RTTI_FLAG "")
	ELSE()
...
SET(SAURON_OUTPUT_SUFFIX _${SAURON_COMPILER_NAME}${SAURON_COMPILER_VERSION})
...
IF(MSVC)
	...
	FUNCTION(CREATE_VCPROJ_USERFILE TARGETNAME)
		...
		SET(SAURON_WORKING_DIR ${WORKING_DIR})

		CONFIGURE_FILE(
			${SAURON_ROOT_DIR}/cmake/VisualStudio2010UserFile.vcxproj.user.in
			${CMAKE_CURRENT_BINARY_DIR}/${TARGETNAME}.vcxproj.user
			@ONLY
		)
	ENDFUNCTION()
ENDIF()
IF(SAURON_PLATFORM_DARWIN OR SAURON_PLATFORM_IOS)
	...
	FUNCTION(CREATE_XCODE_USERFILE PROJECTNAME TARGETNAME)
		IF(SAURON_PLATFORM_DARWIN OR SAURON_PLATFORM_IOS)
			...
			CONFIGURE_FILE(
				${SAURON_ROOT_DIR}/cmake/xcode.xcscheme.in
...
FUNCTION(CREATE_PROJECT_USERFILE PROJECTNAME TARGETNAME WORKING_DIR)
	IF(MSVC)
		CREATE_VCPROJ_USERFILE(${TARGETNAME} ${WORKING_DIR})
	ELSEIF(SAURON_PLATFORM_DARWIN OR SAURON_PLATFORM_IOS)
		CREATE_XCODE_USERFILE(${PROJECTNAME} ${TARGETNAME} ${WORKING_DIR})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(ADD_PRECOMPILED_HEADER TARGET_NAME PRECOMPILED_HEADER PRECOMPILED_HEADER_PATH PRECOMPILED_SOURCE)
	...
	ELSEIF(NOT SAURON_COMPILER_CLANG)
		# TODO: Enables PCH with Clang
		IF(NOT SAURON_PLATFORM_LINUX)
